...
print(fig, '-depsc', '-tiff', '-r300', '../thesis/figures/pulsewoir-200us.eps');
...
fig = plotaf(t_str, delay,v,the_af);
print(fig, '-depsc', '-tiff', '-r300', '../thesis/figures/pulsewir-200us.eps');


fig = figure;
plot(impulse_response);
title('Transfer function');
print(fig, '-depsc', '-tiff', '-r300', '../thesis/figures/tf1.eps');
